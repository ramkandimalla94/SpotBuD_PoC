  ...
  Future<void> saveUserDataFromGoogleSignIn(User user) async {
    try {
      ...
      if (!userSnapshot.exists) {
        ...
        // Add custom machine data to a subcollection
        CollectionReference customMachinesCollection =
            userDoc.collection('customMachines');
        await customMachinesCollection.add({
          'bodypart': 'Chest',
          'machines': [
            {
              'name': 'Bench Press',
            ...
            // Add more chest exercises here if needed
          ],
        });
        ...
        await customMachinesCollection.add({
          ...
          'machines': [
            ...
            // Add more back exercises here if needed
          ],
        });
        ...
        await customMachinesCollection.add({
          ...
          'machines': [
            ...
            // Add more leg exercises here if needed
          ],
        });
