    ...
    try {
      ...
      if (user != null) {
        ...
        await userDoc.set({
          ...
          'email': email,
          'workoutHistory': [], // Initialize workout history as an empty array
        });
      ...
      if (user != null) {
        ...
        if (userSnapshot.exists) {
          ...
          if (userData != null && userData['workoutHistory'] != null) {
            ...
            // Check if 'workoutHistory' exists in userDataMap and is not null
            if (userDataMap.containsKey('workoutHistory')) {
              var workoutHistory = userDataMap['workoutHistory'];

              // Check if workoutHistory is a List<Map<String, dynamic>>
              if (workoutHistory is List) {
                return List<Map<String, dynamic>>.from(workoutHistory);
              }
            }
          }
        }
