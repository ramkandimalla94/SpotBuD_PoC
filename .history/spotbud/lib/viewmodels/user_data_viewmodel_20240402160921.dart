  ...
  Future<void> removeCustomMachine(String bodyPart, String machineName) async {
    try {
      ...
      if (user != null) {
        ...
        // Debug print the current customMachines list
        print('Current customMachines: $customMachines');

        // Remove the machine from the customMachines array
        customMachines.removeWhere((machine) =>
            machine['bodyPart'] == bodyPart &&
            machine['machineName'].contains(machineName));

        // Debug print the updated customMachines list
        print('Updated customMachines: $customMachines');
