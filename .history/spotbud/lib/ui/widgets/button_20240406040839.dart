...
class TextPathPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < text.length; i++) {
      final double x = radius * math.cos(i * angleStep) + size.width / 2;
      final double y = radius * math.sin(i * angleStep) + size.height / 2;
      final double controlX =
          radius * math.cos((i + 0.5) * angleStep) + size.width / 2;
      final double controlY =
          radius * math.sin((i + 0.5) * angleStep) + size.height / 2;
    ...
    final double totalWidth = textPainter.width;
    final double characterSpacing = totalWidth / (text.length - 1);
    ...
    for (int i = 0; i < text.length; i++) {
      ...
      canvas.restore();
      textPainter.width += characterSpacing;
    }
  }
