    ...
    return Container(
      ...
      child: ListWheelScrollView.useDelegate(
        ...
        onSelectedItemChanged: (index) {
          ...
          _fetchWorkoutLogs(
              newSelectedMonth); // Use newSelectedMonth instead of _selectedMonth
        },
        childDelegate: ListWheelChildBuilderDelegate(
          builder: (context, index) {
            // Calculate the month and year to display based on the current index
            final currentDate = DateTime.now();
            final date = DateTime(
              currentDate.year - (index ~/ 12),
              currentDate.month - (index % 12),
