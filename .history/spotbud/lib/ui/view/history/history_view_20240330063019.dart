...
class _HistoryPageState extends State<HistoryPage> {
  ...
  Widget _buildFilterDropdowns() {
    List<String> filteredMachines = machinesList;

    if (selectedBodyPart != null) {
      // Filter machines based on selected body part
      filteredMachines = machinesList.where((machine) {
        // Assuming the machines are stored with a corresponding body part
        // Adjust the condition as per your data structure
        return _machineBodyPartMap[machine] == selectedBodyPart;
      }).toList();
    }
