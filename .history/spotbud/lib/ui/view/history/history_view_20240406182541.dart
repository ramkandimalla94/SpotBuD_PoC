                    ...
                    for (var i = 0; i < workouts.length; i++)
                      ExpansionTile(
                        title: DropdownButtonFormField<String>(
                          value: workouts[i]['startTime'] as String?,
                          items: workouts.map((workout) {
                            //final startTime =
                            return DropdownMenuItem<String>(
                              value: workout['startTime'] as String?,
                              child: Text(
                                  workout['startTime'] as String? ?? 'N/A'),
                            );
                          }).toList(),
                          onChanged: (value) {
                            // You can add logic here to handle start time selection if needed
                          },
                        ),
                        children:
