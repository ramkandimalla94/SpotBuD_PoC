...
void _handleMonthTap(DateTime selectedMonth) {
    // Handle month tap here
    ...
    return SizedBox(
      ...
      child: CupertinoPicker.builder(
        ...
        onSelectedItemChanged: (int index) {
          onChanged(DateTime(selectedMonth.year, index + 1));
        },
        childCount: 12,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: CupertinoPicker.builder(
        ...
        itemExtent: 32,
        onSelectedItemChanged: (int index) {
          onChanged(DateTime(index + 2010, selectedMonth.month));
        },
