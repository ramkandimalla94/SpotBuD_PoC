...
class _ExerciseAnalyticsScreenState extends State<ExerciseAnalyticsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.primaryColor,
        iconTheme: const IconThemeData(color: Theme.of(context).primary),
        title: const Text(
          'Exercise Analytics',
          style: TextStyle(color: Theme.of(context).primary),
        ),
      ),
      body: Obx(
        () {
    ...
    return Container(
      ...
      child: TableCalendar(
        ...
        daysOfWeekStyle: DaysOfWeekStyle(
            ...
            weekendStyle: TextStyle(color: Theme.of(context).primary)),
        firstDay: DateTime(
          DateTime.now().year - 1,
        ),
