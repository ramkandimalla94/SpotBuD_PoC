...
class _ExerciseAnalyticsScreenState extends State<ExerciseAnalyticsScreen> {
  ...
  Widget _buildContent() {
    ...
    String selectedOption = 'Average Weight'; // Default option
    bool isLineGraphSelected = true; // Initial selection
          ...
          if (selectedExercise.isNotEmpty)
            Column(
              ...
              children: [
                ...
                Column(
                  children: [
                    // Chip buttons for selecting graph type
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        // Chip for line graph
                        ChoiceChip(
                          label: Text('Line Graph'),
                          selected: isLineGraphSelected,
                          onSelected: (selected) {
                            setState(() {
                              isLineGraphSelected = selected;
                            });
                          },
                        ),
                        SizedBox(width: 10),
                    ...
                    SizedBox(height: 10),
                    // Conditional rendering of the graph based on selection
