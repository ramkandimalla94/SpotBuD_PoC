...
class _ProfileViewState extends State<ProfileView> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Switch(
                value: _isKgsPreferred,
                onChanged: (value) {
                  setState(() {
                    _isKgsPreferred = value;
                    _updateWeightUnitPreference(value);
                  });
                },
  ...
  void _updateWeightUnitPreference(bool isKgsPreferred) {
    // Update the preference in Firebase
    // Assuming you have a Firebase reference and a field to store the preference
    // For example:
    // firebaseRef.update({'isKgsPreferred': isKgsPreferred});
  }
}
