...
class UserBodyDetials extends StatefulWidget {
  @override
  _UserBodyDetialsState createState() => _UserBodyDetialsState();
}

class _UserBodyDetialsState extends State<UserBodyDetials> {
