    ...
    weightData.forEach((date, weights) {
      ...
      barChartGroups.add(
        BarChartGroupData(
          ...
          barRods: weights
              .map((weight) =>
                  BarChartRodData(toY: weight, color: AppColors.acccentColor))
              .toList(),
      ...
      child: Column(
        children: [
          Expanded(
              child: LineChart(
            LineChartData(
              minX: weightData.keys.first.millisecondsSinceEpoch
                  .toDouble(), // Assuming weightData is not empty
              maxX: weightData.keys.last.millisecondsSinceEpoch.toDouble(),
              minY: 0,
              maxY: weightData.values.reduce((a, b) => a > b ? a : b) + 10,
              ...
              lineBarsData: [
                LineChartBarData(
                  spots: weightData.entries.map((entry) {
                    // Assuming weightData is a Map<DateTime, double>
