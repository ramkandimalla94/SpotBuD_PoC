...
import 'package:charts_flutter/chart_flutter.dart' as charts;
...
class ExerciseAnalyticsScreen extends StatelessWidget {
  ...
  Widget _buildWeightChart(List<Workout> workouts) {
    List<charts.Series<Workout, DateTime>> seriesList = [
      charts.Series(
        id: 'Weight',
        data: workouts,
        domainFn: (Workout workout, _) => DateTime.parse(workout.date),
        measureFn: (Workout workout, _) => double.parse(workout.exercises
