            ...
            child: LineChart(
              LineChartData(
                lineBarsData: [
                  LineChartBarData(
                    spots: [
                      FlSpot(0, 10), // Adjust the coordinates as needed
                      FlSpot(4, 20), // Adjust the coordinates as needed
                      // Add more spots for the trend line
                    ],
                    isCurved: true,
                ...
                minX: 0,
                maxX: 10, // Adjust the maximum x value as needed
                minY: 0,
                maxY: 30, // Adjust the maximum y value as needed
                titlesData: FlTitlesData(
                  bottomTitles:
                      AxisTitles(sideTitles: SideTitles(showTitles: true)),
                  leftTitles:
