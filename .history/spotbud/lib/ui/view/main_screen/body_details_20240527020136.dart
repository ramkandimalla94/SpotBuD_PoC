    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            userDataViewModel.hasInitialData.value = true;
            userDataViewModel.savehasinitialData();
            if (userDataViewModel.role.value == 'trainer') {
              // If user role is trainer, navigate to trainer's main screen
              Get.offNamed('/mainscreentrainer');
            } else if (userDataViewModel.role.value == 'trainee') {
