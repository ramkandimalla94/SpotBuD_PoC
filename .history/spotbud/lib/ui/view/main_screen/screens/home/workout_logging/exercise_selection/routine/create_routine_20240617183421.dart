...
class _CreateRoutineScreenState extends State<CreateRoutineScreen> {
  ...
  void _editExercise(int index) {
    ...
    showDialog(
      context: context,
      builder: (context) {
        // Create TextEditingController for sets
        final setsController = TextEditingController(
          text: exercise['sets'].length.toString(),
        );

        // Create TextEditingControllers for reps and weights
        final repsControllers = List.generate(
          exercise['sets'].length,
          (index) => TextEditingController(
            text: exercise['sets'][index]['reps'].toString(),
          ),
        );
        final weightControllers = List.generate(
          exercise['sets'].length,
          (index) => TextEditingController(
            text: exercise['sets'][index]['weight'].toString(),
          ),
        );
