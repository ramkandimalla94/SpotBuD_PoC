...
class _DailyStepRecordsState extends State<DailyStepRecords> {
  ...
  void _onStepCount(StepCount event) {
    ...
    // Check if the current step count is smaller than the previous step count
    if (currentStepCount < _previousStepCount) {
      // Reset the daily steps to the current step count
      _dailySteps = currentStepCount;
    } else {
      // Calculate the step count for the current day
      _dailySteps = currentStepCount - _previousStepCount;
    }

    setState(() {
      _dailySteps = _dailySteps;
    });
