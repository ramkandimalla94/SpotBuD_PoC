...
class _UserInfoPageState extends State<UserInfoPage> {
      ...
      children: [
        Expanded(
          child: TextField(
            ...
            onChanged: (value) {
              setState(() {
                double heightValue = double.parse(value);
                heightMeters =
                    heightValue.floorToDouble(); // Adjusted to floorToDouble
                heightCentimeters = ((heightValue - heightMeters) * 100)
                    .toInt(); // Adjusted to toInt()
              });
            },
          ),
        ),
          ...
          child: TextField(
            ...
            onChanged: (value) {
              setState(() {
                ...
                heightMeters = (heightCentimeters ~/ 100) as double;
  ...
  String _formatHeightMetersCentimeters() {
    return '$heightMeters meters $heightCentimeters cm';
  }
}
