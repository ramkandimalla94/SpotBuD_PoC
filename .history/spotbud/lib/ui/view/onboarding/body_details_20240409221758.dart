...
class _UserInfoPageState extends State<UserInfoPage> {
  ...
  String _formatHeightMetersCentimeters() {
    int totalInches = (feet * 12) + inches;
    double heightMeters = totalInches * 0.0254; // 1 inch = 0.0254 meters
    int heightCentimeters = (heightMeters * 100).round();
  ...
  String _formatHeightFeetInches() {
    int totalCentimeters = (heightMeters * 100).round();
    int feet = totalCentimeters ~/ 30.48; // 1 foot = 30.48 cm
    double remainingCentimeters = totalCentimeters % 30.48;
    int inches = (remainingCentimeters / 2.54).round();
