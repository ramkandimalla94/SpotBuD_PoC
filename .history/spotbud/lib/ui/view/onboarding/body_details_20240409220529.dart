...
class _UserInfoPageState extends State<UserInfoPage> {
  ...
  // Observable to store weight input in lbs
  final RxDouble weightKg = 0.0.obs;
  // Observable to store weight input in kg
  final Rx<WeightUnit> selectedUnit = WeightUnit.lbs.obs;
  // Observable to store selected weight unit
                ...
                Expanded(
                  ...
                  child: DropdownButton<WeightUnit>(
                    ...
                    onChanged: (value) {
                      ...
                      // If the selected unit is changed, update the weight display
