      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => Text(
                'Weight: ${(selectedUnit.value == WeightUnit.lbs) ? weightLbs.value.toStringAsFixed(2) + ' lbs' : weightKg.value.toStringAsFixed(2) + ' kg'}')),
...
class UserDataViewModel {
  ...
  void saveBodyDetails(double weight, int feet, int inches, Gender gender) {
    // Save body details logic here
  }
}
