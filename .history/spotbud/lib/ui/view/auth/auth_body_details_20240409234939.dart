        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      keyboardType: TextInputType.numberWithOptions(
                          decimal: true), // Only allow numbers and .
                      inputFormatters: [
              ...
              Text('Enter Height:', style: TextStyle(color: Colors.white)),
              // Height input toggle
              Row(
                children: [
                  ElevatedButton(
              ...
              Text('Height: ${_formatHeight()}',
                  style: TextStyle(color: Colors.white)),
              SizedBox(height: 20.0),
              Text('Select Gender:', style: TextStyle(color: Colors.white)),
              // Gender selection
              Obx(
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  if (weightController.text.isEmpty ||
                      ...
                      (!isFeetInches.value && metersController.text.isEmpty)) {
