          ...
          child: Column(
            ...
            children: [
                ...
                validator: (value) {
                  if (value!.isEmpty) {
                    ...
                    return 'Password must be at least 8 characters long';
                      ...
                      .hasMatch(value)) {
                    return 'Password must contain at least one number and one special symbol';
                  }
                  return null;
                },
              ),
              ...
              Padding(
                ...
                child: Text(
                  'The rules of the password should be (at least 8 characters, one number, one special symbol)',
                  ...
                  : buildLoginButton(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          String repassword = passwordController.text.trim();
