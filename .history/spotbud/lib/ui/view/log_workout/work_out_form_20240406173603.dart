  ...
  void _openBodyPartSelection() async {
    ...
    if (result != null && result is Map<String, String>) {
      ...
      if (bodyPart != null && machine != null) {
        var concatenatedExercise = '$bodyPart - $machine';
        var exerciseData = {'bodyPart': bodyPart, 'machine': machine};
        controller.addExercise(exerciseData, concatenatedExercise);
      }
    }
  }
}
...
class WorkoutLoggingFormController extends GetxController {
  ...
  void addExercise(
      Map<String, String> exerciseData, String concatenatedExercise) {
    exercises.add(concatenatedExercise);
    sets[concatenatedExercise] = [SetData(index: 1)];

    // Store exercise data separately in the database
    userDataViewModel.saveExerciseData(exerciseData);
  }
