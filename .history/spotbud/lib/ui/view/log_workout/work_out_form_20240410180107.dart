  ...
  void _openBodyPartSelection() async {
    ...
    if (result != null && result is Map<String, String>) {
      ...
      if (bodyPart != null && machine != null) {
        ...
        // Check if there are previous sets for the selected exercise
        var previousSets = controller.getSets(exercise);
        if (previousSets.isNotEmpty) {
          // Display the previous reps and weight as hint text for the first set
          var previousReps = previousSets.first.reps;
          var previousWeight = previousSets.first.weight;
          if (previousReps.isNotEmpty && previousWeight.isNotEmpty) {
            Get.defaultDialog(
              title: 'Previous Log',
              content: Column(
                children: [
        ...
        // If there are no previous sets or previous reps and weight, simply add the exercise
        controller.addExercise(exercise);
      }
    }
  }
