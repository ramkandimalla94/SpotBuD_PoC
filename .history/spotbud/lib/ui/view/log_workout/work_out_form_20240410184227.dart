  ...
  void _openBodyPartSelection() async {
    ...
    if (result != null && result is Map<String, String>) {
      ...
      if (bodyPart != null && machine != null) {
        ...
        // Set hint text for reps and weight based on fetched values
        controller.getSets(exercise).first.reps = 'Fetched Reps';
        controller.getSets(exercise).first.weight = 'Fetched Weight';
      }
    }
  }
}
