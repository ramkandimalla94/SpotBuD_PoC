  ...
  void _openBodyPartSelection() async {
    ...
    if (result != null && result is Map<String, String>) {
      ...
      if (bodyPart != null && machine != null) {
        ...
        try {
          var loggedDetails = await getLoggedDetailsByMachine(machine);
          if (loggedDetails.isNotEmpty) {
            ...
            // Show the dialog with hint text for reps and weight
            Get.defaultDialog(
              title: 'Previous Log',
              content: Column(
                children: [
                  TextField(
                    decoration: InputDecoration(
                      labelText: 'Reps',
                      hintText: 'Previous Reps: $previousReps',
                    ),
                  ),
                  TextField(
                    decoration: InputDecoration(
                      labelText: 'Weight',
                      hintText: 'Previous Weight: $previousWeight',
                    ),
                  ),
                ],
              ),
