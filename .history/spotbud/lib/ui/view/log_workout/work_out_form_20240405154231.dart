        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text(
                  'Start Time: ${DateTimeUtils.getFormattedTime(DateTime(_selectedDate.year, _selectedDate.month, _selectedDate.day, _selectedTime.hour, _selectedTime.minute))}',
                  style: TextStyle(color: Colors.white),
                ),
                Spacer(),
                IconButton(
  ...
  void _saveWorkout() {
    ...
    Map<String, dynamic> workoutData = {
      ...
      'endTime': DateTimeUtils.getFormattedTime(DateTime(
          ...
          _selectedDate.day,
          _selectedTime.hour,
          _selectedTime.minute)), // End time set to current time
