...
class _WorkoutLoggingFormState extends State<WorkoutLoggingForm> {
  ...
  void _openExerciseHistoryDialog(String exerciseName) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Container(
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection('workouts').where(
                  'exercises',
                  arrayContains: {'machine': exerciseName}).snapshots(),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  // You can customize the UI to display workout logs here
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        title: Text(
                            (workoutData as Map<String, dynamic>)['Date'] ??
                                'Data Not Available'),
