...
class BodyPartSelectionScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> bodyParts = [
    {'name': 'Legs', 'imagePath': 'assets/legs_image.png'},
    {'name': 'Chest', 'imagePath': 'assets/chest_image.png'},
    {'name': 'Back', 'imagePath': 'assets/back_image.png'},
    {'name': 'Arms', 'imagePath': 'assets/arms_image.png'},
    {'name': 'Shoulders', 'imagePath': 'assets/shoulders_image.png'},
