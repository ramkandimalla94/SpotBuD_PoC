...
class _WorkoutLoggingFormState extends State<WorkoutLoggingForm> {
  ...
  void _saveWorkout() {
    ...
    Map<String, dynamic> workoutData = {
      'date': DateTimeUtils.getFormattedDate(DateTime.now()),
      'startTime': DateTimeUtils.getFormattedTime(DateTime.now()),
      'endTime': DateTimeUtils.getFormattedTime(
          DateTime.now()), // End time set to current time
