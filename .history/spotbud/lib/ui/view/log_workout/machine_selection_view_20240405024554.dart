  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: 5, // Example number of exercises
        itemBuilder: (context, index) {
          return ListTile(
            title: Text('Exercise $index for $bodyPart'),
            onTap: () {
              final workoutLoggingFormController =
                  Get.find<WorkoutLoggingFormController>();
              workoutLoggingFormController
                  .addExercise('Exercise $index for $bodyPart');
              Get.back();
            },
          );
        },
