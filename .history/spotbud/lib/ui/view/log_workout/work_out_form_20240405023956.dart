...
import 'package:spotbud/utils/date_time_utils.dart';
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Today\'s Date: ${DateTimeUtils.formatDate(DateTime.now())}',
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Text(
                    DateTimeUtils.formatTime(_startTime),
                    style: TextStyle(color: Colors.white),
                  ),
                  Spacer(),
                  Text(
                  ...
                  SizedBox(width: 10),
                  Text(
                    DateTimeUtils.formatTime(_endTime),
                    style: TextStyle(color: Colors.white),
                  ),
                ],
              ),
