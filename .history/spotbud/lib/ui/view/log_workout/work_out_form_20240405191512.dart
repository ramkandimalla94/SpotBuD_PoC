...
class _WorkoutLoggingFormState extends State<WorkoutLoggingForm> {
  ...
  void _saveWorkout() {
    ...
    for (var exercise in controller.exercises) {
      final parts = exercise.split(' - '); // Split bodyPart and exerciseName
      final bodyPart = parts[0];
      final exerciseName = parts[1];
  ...
  void _openBodyPartSelection() async {
    ...
    if (result != null && result is Map<String, String>) {
      ...
      if (bodyPart != null && machine != null) {
        ...
        controller.addExercise(bodyPart: bodyPart, exerciseName: machine);
      }
    }
  }
}
...
class WorkoutLoggingFormController extends GetxController {
  ...
  void addExercise(String exercise) {
    exercises.add('$bodyPart - $exerciseName');
    sets['$bodyPart - $exerciseName'] = [SetData(index: 1)];
  }
