...
class MachineSelectionScreen extends StatelessWidget {
  final UserDataViewModel userDataViewModel =
      Get.find(); // Get the UserDataViewModel instance
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (userDataViewModel.loading.value) {
          // Use userDataViewModel.loading
          return Center(
            child: LoadingIndicator(),
          );
        } else {
          return ListView.builder(
            itemCount: userDataViewModel
                .bodyParts.length, // Use userDataViewModel.bodyParts
            itemBuilder: (context, index) {
              final bodyPart = userDataViewModel
                  .bodyParts[index]; // Use userDataViewModel.bodyParts
              final machines =
                  userDataViewModel.machinesByBodyPart[bodyPart] ?? [];
