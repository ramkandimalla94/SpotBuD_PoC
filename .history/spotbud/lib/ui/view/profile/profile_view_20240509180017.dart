          ...
          children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                _userDataViewModel.isDarkTheme.value = false;
                              });
                            },
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: _userDataViewModel.isDarkTheme.value
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                _userDataViewModel.isDarkTheme.value = true;
                              });
                            },
                            child: Container(
                              padding: EdgeInsets.all(4),
            ...
            Padding(
              ...
              child: buildLoginButton(
                text: "Log Out",
                onPressed: () {
                  print(_userDataViewModel.isDarkTheme.value);
