...
class _HeightSettingScreenState extends State<HeightSettingScreen> {
  ...
  int _heightInInches = 0;
   _heightInMeters = 1.52; // Default height in meters
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text('Preview:'),
                          Text(
                              '${_heightInMeters.toStringAsFixed(2)} meters ${_heightInCentimeters.toStringAsFixed(0)} centimeters'),
                        ],
                      ),
                    ],
                  )
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text('Preview:'),
                          Text(
                              '${_heightInFeet.floor()} feet ${_heightInInches.floor()} inches'),
                        ],
                      ),
                    ],
                  ),
