    ...
    return Scaffold(
      body: Column(
        ...
        children: [
              ...
              Expanded(
                child: CupertinoPicker.builder(
                  ...
                  onSelectedItemChanged: (index) {
                    setState(() {
                      selectedFeet = index;
                      selectedMeters = (index * 30.48 ~/ 100)
                          .toInt(); // Convert feet to meters
                    });
                  },
                ...
                child: CupertinoPicker.builder(
                  ...
                  onSelectedItemChanged: (index) {
                    setState(() {
                      ...
                      selectedCentimeters = (index * 2.54)
                          .toInt(); // Convert inches to centimeters
                    });
                  },
                  itemBuilder: (BuildContext context, int index) {
          ...
          // Add a divider between the two pickers
