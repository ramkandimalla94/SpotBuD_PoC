...
class _HeightSettingScreenState extends State<HeightSettingScreen> {
  ...
  double _heightInMeters = 0; // Default height in meters
            ...
            _useFeetAndInches
                ? Row(
                    children: [
                      ...
                      SizedBox(width: 10),
                      if (_heightInFeet != 0 ||
                          _heightInInches != 0) // Check if fields are not empty
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Preview:'),
                            Text(
                                '${heightInMeters.toStringAsFixed(2)} meters ${heightInCentimeters.toStringAsFixed(0)} centimeters'),
                          ],
                        ),
                    ],
                  )
                : Row(
                    children: [
                      ...
                      if (_heightInMeters != 0 ||
                          _heightInCentimeters !=
                              0) // Check if fields are not empty
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Preview:'),
