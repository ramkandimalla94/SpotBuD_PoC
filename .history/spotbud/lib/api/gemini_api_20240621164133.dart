...
class GeminiApiService {
  ...
  Future<void> initialize() async {
    ...
    _chat = _model.startChat(history: [
      Content.text('You are a fitness and gym assistant. Help users with workout advice and gym-related queries.'),
      Content.model([TextPart('Understood. I am here to help with fitness and gym-related questions. How can I assist you today?')])
    ]);
  }
